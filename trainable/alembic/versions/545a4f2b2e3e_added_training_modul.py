...
INSERTS = """
INSERT INTO modules (id, name, description, label, label_plural, clazzpath, display, str_repr, uuid) VALUES (1000, 'trainings', '', 'Training', 'Trainings', 'trainable.model.training.Training', 'header-menu', '%s|id', 'aa65cb6d-3d61-43f1-87f1-23e6e00b01c7');
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['gid'], ['usergroups.id'], name='fk_trainings_gid_usergroups', use_alter=True),
    sa.ForeignKeyConstraint(['uid'], ['users.id'], name='fk_trainings_uid_users', use_alter=True),
